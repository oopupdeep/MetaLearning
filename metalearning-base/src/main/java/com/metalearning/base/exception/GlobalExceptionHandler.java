...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(MetalearningException.class)//此方法捕获MetalearningException异常
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)//状态码返回500
    public RestErrorResponse doMetalearningException(MetalearningException e){
...
//    public RestErrorResponse doValidException(MethodArgumentNotValidException
