package com.metalearning.orders.service.impl;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper;
import com.metalearning.base.exception.MetalearningException;
import com.metalearning.base.utils.IdWorkerUtils;
import com.metalearning.base.utils.QRCodeUtil;
import com.metalearning.messagesdk.service.MqMessageService;
import com.metalearning.orders.config.PayNotifyConfig;
import com.metalearning.orders.mapper.XcOrdersGoodsMapper;
import com.metalearning.orders.mapper.XcOrdersMapper;
import com.metalearning.orders.mapper.XcPayRecordMapper;
...
import com.metalearning.orders.model.po.XcOrdersGoods;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto createOrder(String userId, AddOrderDto addOrderDto) {
        ...
        try {
            ...
            MetalearningException.cast("生成二维码出错");
        }
        //封装要返回的数据
